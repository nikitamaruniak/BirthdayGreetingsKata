...
{
    public class GivenOneAndOnlyBirthdayOtherDay : IClassFixture<GivenOneAndOnlyBirthdayOtherDay.Fixture>
    {
        ...
        public GivenOneAndOnlyBirthdayOtherDay(Fixture fixture)
        {
